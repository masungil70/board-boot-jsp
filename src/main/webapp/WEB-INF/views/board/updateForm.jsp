	...
	<div class="container">
		...
		<form id="frm" action="/board/update.do" method="post" >
			...
			<div class="mb-3">
			    ...
			    <input type="text" class="form-control" name="title" value="${boardResponse.title}" required >
			</div>
			<div class="mb-3">
		    	<label class="form-label font-weight-bold"><span class="text-danger">* </span>내용</label>
		    	<textarea class="form-control" rows="5" name="content" required >${boardResponse.content}</textarea>
			</div>
			<div class="mb-3">
